function [U,flag]=disloc3d4(m,x,lambda,mu)
% DISLOC3D    [U,flag]=disloc3d4(m,x,lambda,mu)
%
...
%
% Added dykes and sills - tjw 12 aug 09
...
for i=1:nfaults
    ...
    elseif (m(10,i) == 2 )
        % TENSILE ONLY COMPONENT SOLUTION, DYKES
        [ux,uy,uz,err]=dc3d5(alpha,X,Y,-dip,al1,al2,aw1,aw2,0,0,opening);
    elseif (m(10,i) == 3 )
        % TENSILE ONLY COMPONENT SOLUTION, SILLS
